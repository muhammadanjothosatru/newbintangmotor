                        ...
                        <div class="d-flex align-items-center justify-content-center vh-100">
                                ...
                                <div class="d-flex align-items-center justify-content-center pt-4 pb-4">
                                    ...
                                    <div class="card-body align-items-center">
                                        <div class="d-flex justify-content-center form-label mb-4">
                                            <h5 style="font-weight: bold !important;">Login Admin Website</h5>
                                        </div>
                                        ...
                                        @endif
                                        <div class="col">
                                            <form action="{{url('adminlogin')}}" method="POST" id="logForm">
                                                @csrf
