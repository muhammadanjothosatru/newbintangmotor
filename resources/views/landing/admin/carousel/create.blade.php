...
@section('konten')
    <div class="card">
        ...
        <form id="form" action="{{ route('carousel.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="m-4">
                <div class="row pl-0 pr-0">
                    ...
                    <div class="font-form-header mb-3 col-6 d-flex justify-content-end">
                        <a href="{{ route('carousel.index') }}" class="btn btn-primary btn-sm"><i
                        ...
                        <div class="mb-3 row">
                            <label for="namapromo"  class="col-sm-2 col-form-label font-form">Nama Promo</label>
                                <div class="col-sm-10 col-form-label">
                                    <input type="text" name="namapromo" value="{{ old('namapromo') }}" required="required" class="form-control form-control-size" placeholder="Masukkan Nama Promo" id="namapromo">
                                </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="linkpromo"  class="col-sm-2 col-form-label font-form">Link Promo</label>
                                <div class="col-sm-10 col-form-label">
                                    <input type="text" name="linkpromo" value="{{ old('linkpromo') }}" required="required" class="form-control form-control-size" placeholder="Masukkan Link Promo" id="linkpromo">
                                </div>
                        </div>
                        <div class="mb-3 row">
