                ...
                <div class="m-4">
                    <div class="row pl-0 pr-0">
                        ...
                        <div class="font-form-header mb-3 col-6 d-flex justify-content-end">
                            <a href="{{ route('datamanagement.edit', $data->id) }}" class="btn btn-primary btn-sm mr-2"><i
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="form-floating col-sm-10">
                                    @foreach ($rowcount as $counter)
                                        <textarea class="form-control textarea-control-size" rows="{{ $counter->baris + 1 }}"
                                            style="height:100% !important; 
                                    resize: none;"name="deskripsi"
                                            placeholder="Masukkan Deskripsi" id="deskripsi" readonly>{{ $data->deskripsi }}</textarea>
                                    @endforeach
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="kilometer" value="{{ $data->kilometer }}"
                                        ...
                                        placeholder="Masukkan Kilometer Kendaraan" id="kilometer" readonly>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10 col-form-label">
                                    <input type="text" name="dp" value="{{ $data->dp }} Juta"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10 col-form-label">
                                    <input type="text" name="bulan" value="{{ $data->bulan }} Bulan"
                                        required="required" class="form-control form-control-size" id="bulan" 
                                        readonly>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="inputHarga" class="col-sm-2 col-form-label font-form">Foto</label>
                            </div>
                            <div class="row">
