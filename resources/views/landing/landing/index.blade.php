    ...
    <div class="header-main">
      ...
      <div class="container">
        ...
        <a href="#" class="header-logo">
          <img src="{{asset('landing/assets/images/logo/logo.svg')}}" alt="Anon's logo" width="120" height="36">
        </a>
          ...
          <li class="menu-category">
            ...
            <div class="dropdown-panel">
              ...
              <ul class="dropdown-panel-list">
                ...
                <li class="panel-list-item">
                  <a href="#">
                    <img src="{{asset('landing/assets/images/electronics-banner-1.jpg')}}" alt="headphone collection" width="250"
                      height="119">
                  </a>
                </li>
