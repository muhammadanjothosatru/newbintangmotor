  ...
  @endif
    ...
    <div class="m-4">
        <div class="row pl-0 pr-0">
            <div class="font-form-header mb-3 col-6">Masukkan Data Cabang</div>
            ...
            <div class="col-6">
                <div class="mb-3 row">
                    <label for="inputNIK"  class="col-sm-2 col-form-label font-form">Nama Cabang</label>
                        <div class="col-sm-10">
                            <input type="text" name="nama" value="{{ old('nama') }}" required="required" class="form-control form-control-size" placeholder="Masukkan Nama Cabang" id="username">
                        </div>
                </div>
                <div class="mb-3 row">
