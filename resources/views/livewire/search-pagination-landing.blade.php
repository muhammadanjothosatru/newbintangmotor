                ...
                @foreach ($itemCategory as $data)
                    <li class="list-group-item {{ $data->state }}">
                        <button class="sidebar-accordion-menu" data-accordion-btn
                            wire:click="buttonFilter('{{ $data->kategori }}')">
    ...
    <div class="product-main" style="width: 100%;">
        <div class="container" id="sticky">
            <div class="header-search-container">
                ...
                <input type="search" name="search" class="search-field" placeholder="Cari Nama Produk"
                    ...
                    <div class="showcase">
                        <a href="{{ route('landing.detail', $data->id) }}">
                            <div class="showcase-banner">
                                ...
                                <img src="{{ asset('storage/foto_kendaraan/' . $data->foto[0]) }}"
