...
class TransaksiController extends Controller
{
    ...
    { 
        ...
        $transaksi_motor =DB::table('transaksi')
                ...
                return view('pos.transaksi.index', compact('all_transaksi_motor'));
    ...
    public function create()
    {
        ...
        return view('pos.transaksi.create', compact('pelanggan','all_kendaraan'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pos.transaksi.edit', compact('transaksi', 'pelanggan', 'pelangganall', 'kendaraan', 'kendaraanall', 'nopol'));
    }
    ...
    public function detail($id)
    {
        ...
        return view('pos.transaksi.detail', compact('transaksi', 'pelanggan', 'kendaraan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        Kendaraan::where('no_pol', $request->no_pol)->update(['status_kendaraan' => 'Terjual']);
        return redirect()->route('pos.transaksi.index')->with('success','Data transaksi anda berhasil diupdate'); 
    }
