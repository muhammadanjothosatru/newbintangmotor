...
class KendaraanController extends Controller
{
    ...
    public function mobil()
    {
        $kendaraanmobil =DB::table('kendaraan')
                ...
                return view('pos.kendaraan.mobil',compact('allkendaraan'));
    }
    /**
    ...
    public function index()
    {
        ...
        $kendaraanmotor =DB::table('kendaraan')
                ...
                return view('pos.kendaraan.index',compact('kendaraan','allkendaraan')); 
    }
    ...
    public function create()
    {
        ...
        return view('pos.kendaraan.create',compact('allkendaraan'));
    }
    ...
    public function detail($no_pol)
    {
        ...
        return view('pos.kendaraan.detail', compact('kendaraan'));
    }
    public function edit($no_pol)
    {
        ...
        return view('pos.kendaraan.edit', compact('kendaraan', 'allkendaraan'));
    }
    ...
    public function update(Request $request, $no_pol)
    {
        ...
        try{
            ...
            self::updateData($request, $kendaraan);
            return redirect()->route('pos.kendaraan.index')->with('success','Data Kendaraan anda berhasil diupdate');
        }
    ...
    public function destroy($no_pol)
    {
        $kendaraan = Kendaraan::findorfail($no_pol);
        $kendaraan->delete();
        return redirect()->route('pos.kendaraan.index')->with('success','Data Kendaraan anda berhasil dihapus');
    }
