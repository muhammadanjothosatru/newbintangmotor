...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pos.user.index',compact('user'));
    }
    ...
    {
        $cabang = Cabang::all();
        return view('pos.user.create', compact('cabang'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('pos.user.edit', compact('user','cabang','cabangall'));
    }
    ...
    {
        $user = User::findorfail($id);
        return view ('pos.user.ubahPassword', compact('user'));
    }
    ...
    public function destroy($id)
    {
        $user = User::findorfail($id);
        $user->delete();
        return redirect()->route('pos.user.index')->with('success','Data user anda berhasil dihapus');
    }
}
