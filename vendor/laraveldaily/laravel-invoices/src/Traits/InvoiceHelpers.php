...
trait InvoiceHelpers
{
    ...
    public function bg_kwitansi(string $bg_kwitansi)
    {
        $this->bg_kwitansi = $bg_kwitansi;
     ...
     * @return mixed
     */
    public function getDPinWords($dp_tunai)
    {
        return $this->getAmountInWords($dp_tunai);
    }
    ...
    public function getBgKwitansi()
    {
        $type = pathinfo($this->bg_kwitansi, PATHINFO_EXTENSION);
        $data = file_get_contents($this->bg_kwitansi);
